    ...
    <div class="mt-5">
            ...
            <div class="col-span-12 md:col-span-4 mb-5">
                ...
                <div class="mt-5">
                   <ul class=" list-disc list-inside">
                    ...
                    <li><Link href="{{ route('help') }}">Help</Link></li>
                   </ul>
                </div>
            </div>
        </div>
        ...
        <div class="mt-5">
            <div class="grid grid-cols-12 gap-3">
                ...
                <div class="col-span-12 md:col-span-4 mb-5">
                    <h2 class=" text-xl font-semibold text-gray-800"><Link href="{{ route('images.main.products',$category->slug) }}">{{ $category->name }}</Link></h2>
                    ...
                    <div class="mt-5">
                       <ul class=" list-disc list-inside leading-7">
                        ...
                        <li>
                            <Link href="{{ route('images.subcat.products',['mainCatSlug'=>$category->slug, 'subCategorySlug'=>$subCat->slug]) }}" >{{ $subCat->name }}</Link>
                        </li>
                        @endforeach
                       </ul>
                    </div>
            ...
            <div class="grid grid-cols-12 gap-3">
                ...
                <div class="col-span-12 md:col-span-4 mb-5">
                    ...
                    <ul class=" list-disc list-inside leading-7">
                        ...
                        <li><Link href="{{ route('show.product',$product->slug) }}">{{ $product->name }}</Link></li>
                        @endforeach
                    </ul>
                    </div>
                </div>

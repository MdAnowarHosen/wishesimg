<div class=" bg-gray-100">
    <div class=" min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0">
        <div class="rounded-lg mx-3 md:mx-0 px-10 md:px-6  md:w-full sm:max-w-md mt-6 py-10 bg-white shadow-md overflow-hidden sm:rounded-lg">
        ...
        {{-- bottom sticky ads --}}
       <div class="container mx-auto  sticky bottom-0 mt-3">

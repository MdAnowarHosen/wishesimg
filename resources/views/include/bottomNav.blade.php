     ...
     <div class="block sm:hidden fixed z-30 w-full h-16 max-w-lg -translate-x-1/2 bg-white border border-gray-200 rounded-t-lg bottom-0 left-1/2 dark:bg-gray-700 dark:border-gray-600">
